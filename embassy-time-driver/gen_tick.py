...
# dynamic tick rate feature
feats_time += f"## Dynamic Tick Rate\n"
feats_time += f"dynamic-tick-rate = [\"embassy-time-driver/dynamic-tick-rate\"]\n"
feats_driver += f"## Dynamic Tick Rate\n"
feats_driver += f"dynamic-tick-rate = []\n"
...
with open('src/tick.rs', 'w') as f:
    ...
    f.write('#[cfg(not(any(\n')
    f.write('feature = "dynamic-tick-rate",\n')
    for hz in ticks:
